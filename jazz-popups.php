...
if (isset($_REQUEST['notify_save'])) {
    if (!is_user_logged_in() || !(isset($_POST['nonce']) && wp_verify_nonce($_POST['nonce'], 'jazz-popups'))) {
    ...
    $data = sanitize_text_field($_REQUEST['content']);
    $table = $wpdb->prefix . 'notify';
    $data1 = array(
        'type' => $type,
...
function test_init() {
    ...
    <div id="test-popup" class="white-popup mfp-with-anim mfp-hide"></div>
        ...
        <?php $nonce = wp_create_nonce('jazz-popups'); ?>
